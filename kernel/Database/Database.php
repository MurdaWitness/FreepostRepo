...
class Database implements DatabaseInterface
{
    ...
    public function regexp(string $table, array $conditions): array
    {
        $whereClauses = [];
        $params = [];

        foreach ($conditions as $column => $regexp) {
            $whereClauses[] = "LOWER($column) REGEXP :$column";
            $params[$column] = strtolower($regexp);
        }
